...
export const rawProjects: RawProject[] = [
  {
    ...
    name: "Lumen Bloom",
    description:
      "現在地の太陽・月の位置と天気をリアルタイムに映す、常時起動できる3Dウォールペーパー。部屋の隅の花瓶には週替わりでその季節の花や枝物（ひまわり・チューリップ・コスモス・芍薬・紫陽花・梅・桜・紅葉・南天の全9種、花に合わせて透明/色ガラス・陶器の花瓶も変化、南半球は季節6ヶ月シフト）が生けられ、窓格子越しの実太陽光が桟の影ごと床と壁に落ち、夜は月齢に応じた月明かり。天気（晴れ/曇り/霧/雨/雪/雷雨）は空の色・霧・雨雪パーティクル・稲光・床の積雪・氷点下のガラスの曇りとして反映され、時刻・天気・今週の花・月相のHUDと画面スリープ防止（Wake Lock）で置き時計のようにも使える。URLパラメータで任意の場所・時刻・アレンジを固定して共有可能。",
    ...
    testCoverage: {
      ...
      tests: 190, measuredAt: "2026-07-15",
