...
export const rawProjects: RawProject[] = [
  ...
  },
  {
    ...
    name: "Somewhere Now",
    description:
      "世界33の国と地域・140地点のYouTubeライブカメラを地図から選んで覗くアプリ。地図には太陽位置から求めた昼夜の境界(ターミネータ)が引いてあり、「いま夜の場所だけ」で絞り込める。選んだ場所は現地時刻・現在の天気・視聴者数つきで表示され、最大4枚を2×2で同時に眺められる。ライブ配信は終わり videoId も変わるため、カメラの定義(静的)と生存状態(動的)を分離し、Cloudflare Worker の Cron が YouTube Data API で生存を追い続ける。日本語/英語対応。",
